...
{
	// GBG.VisualPlayable.AnimationBrain.SetLayerWeight
[UnitCategory("Visual Playable/Animation Brain")]
[UnitTitle("Set Layer Weight(By Index)")]
internal class Node_AnimationBrain_SetLayerWeight_By_Index : Unit
{
	// Input trigger
...
Input_weight = ValueInput<Single>(nameof(Input_weight));
...
Requirement(Input_weight, InputTrigger);
...
var Value_Output_Boolean = Value_Input_AnimationBrain.SetLayerWeight(Value_Input_layerIndex, Value_Input_weight);
