...
[UnitTitle("Set Layer Weight(By Name)")]
internal class Node_AnimationBrain_SetLayerWeight_By_Name : Unit
{
	// Input trigger
...
var Value_Output_Boolean = Value_Input_AnimationBrain.SetLayerWeight(Value_Input_layerName, Value_Input_weight);
