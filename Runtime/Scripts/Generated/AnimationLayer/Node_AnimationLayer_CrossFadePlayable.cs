...
{
	// GBG.VisualPlayable.AnimationLayer.CrossFadePlayable
[UnitCategory("Visual Playable/Animation Layer")]
[UnitTitle("Cross Fade Playable")]
internal class Node_AnimationLayer_CrossFadePlayable : Unit
{
	// Input trigger
...
Value_Input_AnimationLayer.CrossFadePlayable(Value_Input_tag, Value_Input_playable, Value_Input_speed, Value_Input_fixedFadeTime, Value_Input_fixedOffsetTime, Value_Input_frozeSource);
} catch(Exception e) {
